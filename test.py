...
import time
from ImageParser.Colors import blue_color, could_upgrade_grey
...
ti = TransformationImage("ImageParser/test-images/farm-dia.png", identifier)
